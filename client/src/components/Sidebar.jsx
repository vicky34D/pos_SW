export default function Sidebar({ activeView, onViewChange, currentUser }) {
  const navItems = [
    ...
    { id: 'tables', label: 'Tables',
      icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="10" width="18" height="4" rx="1"/><path d="M5 14v7M19 14v7M2 10l2-6h16l2 6"/></svg>,
      roles: ['Admin','Manager','Employee','Viewer'] },
